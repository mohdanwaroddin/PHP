					...
					<div class="panel panel-default">
                        ...
                        <div class="col-md-12">
                            ...
                            while ($row=mysqli_fetch_array($ret)) {
                            	...
                            	$cuD=date();
                            	$date1 = new DateTime($inD);
                                $date2 = new DateTime($cuD);
                            ...
                            ?> 
                                ...
                                <div class="form-group">
									...
									<input type="text" class="form-control" placeholder="" id="parkingcharge" name="parkingcharge" value="<?php 
									...
									else if($row['VehicleCategory']=="Three Wheeler"){
                                        if($diff==0){
										echo(20);
										}elseif($diff>0 && $diff<=30){
											echo($diff*20);
                                ...
                                <div class="form-group">
									<label>Remarks</label>
									<input type="text" class="form-control" placeholder="" value="Paid" id="remark" name="remark" required>
								</div>
